...
This is a fork of MrAfitol's Lobby plugin but with [RueI](https://github.com/Ruemena/RueI) support for my own server. I will not be updating this more than likely and you'll have to build it yourself. (and resolve dependencies yourself, I haven't uploaded the updated .csproj file.)
